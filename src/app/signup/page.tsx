...
const Page = () => {
  ...
  return (
    <main className="bg-[rgba(51,51,51,0.90)] h-[1100px] lg:h-[1300px] w-[100%] ">
      ...
      <div className="lg:jusify-between  flex hidden bg-[rgba(51,51,51,0.90)] lg:flex bg-cover w-[100%] lg:h-[1300px]">
        <main className='py-[4rem]  lg:pt-[100px] lg:h-[1300px] lg:w-[55%] w-[100%] h-[900px]'>
          ...
          <div className=' pt-[6rem] p-[50px] xl:p-[6rem] lg:w-[100%]'>
            ...
            <p className="text-[#fafafa] mb-[5px] text-[24px] font-[600] ">Sign Up</p>
            ...
            <div className="">
              <p className='text-[16px] lg:text-[24px] text-[#B8B8B8] font-[500]  '>Username</p>

              <div className="text-center flex mt-[8px] text-[#B8B8B8] border-[2px] border-[#B8B8B8] rounded-[0.8rem] p-[14px]">
                <Icon name='user.svg' classes='w-[40px] mr-[25px] h-[40px]' size={2} />
            ...
            <div className='flex mt-[24px]'>
              ...
              <div className='flex'>
                <p className='text-[16px] lg:text-[24px] text-[#B8B8B8] font-[400] '>I agree to the<span className='text-[#FAFAFA] ml-[5px]'> Terms and Policies of Afrocarb</span> </p>

              </div>
            </div>

            <p className="text-[1rem] mt-[50px] font-[400] text-center text-[#FAFAFA] bg-[#417505] rounded-[10px] px-[1rem] p-[0.8rem]">Sign Up</p>
            ...
            <div className='flex my-[25px] justify-center items-center'>
              ...
              <span className='text-[16px] lg:text-[24px] text-[#FAFAFA] font-[400] ml-[5px]'> Reset</span>
            </div>

            <div className='flex flex-col justify-center items-center'>
              <p className='text-[16px] lg:text-[24px] text-[#B8B8B8] font-[400] '>Already have an account with us? </p>
              <Link href='/login'>
                <span className='text-[#FAFAFA] text-[16px] lg:text-[24px] font-[400] ml-[5px]'> Sign In</span>
              </Link>
            </div>
      ...
      <div className="absolute top-0 left-0 z-[10] bg-[url('/rings.svg')] lg:hidden bg-cover w-[100%] lg:h-[1300px] ">
        ...
        <main className='py-[4rem] lg:pt-[200px] px-[24px] lg:p-[6rem]  bg-[rgba(51,51,51,0.90)] lg:h-[1300px] h-[1100px]'>

          <div className=' lg:pt-[6rem] p-[24px] xl:p-[6rem] lg:w-[100%]'>
            ...
            <div className='flex flex-col justify-center items-center'>
              <p className='text-[16px]  text-[#B8B8B8] font-[400] '>Already have an account with us? </p>
              <Link href='/login'>
                <span className='text-[#FAFAFA] ml-[5px]'> Sign In</span>
              </Link>
            </div>
