  ...
  return (
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative w-[100%] z-[1000]" onClose={closeModal}>
          <Transition.Child
            as={Fragment}
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="flex flex-col items-center max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all ">
                  ...
                  <div className="mt-2">
                    <div>
                      <button className="flex justify-between items-center p-3 w-[100%] my-2 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white" onClick={() => handlePlena()}>
                        <div className='mx-2 flex items-center'>

                          <span className="flex-1 ml-3 whitespace-nowrap">Plena Wallet</span>
                        </div>
